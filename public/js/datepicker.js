...
!function( $ ) {
	...
	Datepicker.prototype = {
		...
		place: function(){
			...
			var eleWidth = this.component? this.component.outerWidth() : this.element.outerWidth();
			if(left + 217 > bodyWidth) {
				left = left + eleWidth - 217;
				this.picker.addClass('datepickerRight').append('<style>.datepickerRight:before{left: auto; right: 6px;}.datepickerRight:after{left: auto; right: 7px;}</style>');
			}
			this.picker.css({
